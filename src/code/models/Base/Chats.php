...
/**
 * Base class that represents a row from the 'public.chats' table.
 *
 *
 *
 * @package    propel.generator.code.models.Base
 */
abstract class Chats implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\code\\models\\Map\\ChatsTableMap';
    ...
    /**
     * Initializes internal state of code\models\Base\Chats object.
     */
    ...
    /**
     * Compares this with another <code>Chats</code> instance.  If
     * <code>obj</code> is an instance of <code>Chats</code>, delegates to
     * <code>equals(Chats)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ChatsTableMap::COL_ID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[ChatsTableMap::COL_STATUS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ChatsTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ChatsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            if ($this->deleted_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->deleted_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ChatsTableMap::COL_DELETED_AT] = true;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[ChatsTableMap::COL_CREATED_BY] = true;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[ChatsTableMap::COL_UPDATED_BY] = true;
        }
    ...
    public function setDeletedBy($v)
    {
        ...
        if ($this->deleted_by !== $v) {
            $this->deleted_by = $v;
            $this->modifiedColumns[ChatsTableMap::COL_DELETED_BY] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChatsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildChatsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChatsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('public.chats_id_seq')");
        ...
        if ($this->isColumnModified(ChatsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(ChatsTableMap::COL_DELETED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'deleted_at';
        }
        if ($this->isColumnModified(ChatsTableMap::COL_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'created_by';
        }
        if ($this->isColumnModified(ChatsTableMap::COL_UPDATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'updated_by';
        }
        if ($this->isColumnModified(ChatsTableMap::COL_DELETED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'deleted_by';
        }

        $sql = sprintf(
            'INSERT INTO public.chats (%s) VALUES (%s)',
    ...
    {
        $pos = ChatsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Chats'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Chats'][$this->hashCode()] = true;
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\code\models\Chats The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ChatsTableMap::COL_UPDATED_AT)) {
            $criteria->add(ChatsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(ChatsTableMap::COL_DELETED_AT)) {
            $criteria->add(ChatsTableMap::COL_DELETED_AT, $this->deleted_at);
        }
        if ($this->isColumnModified(ChatsTableMap::COL_CREATED_BY)) {
            $criteria->add(ChatsTableMap::COL_CREATED_BY, $this->created_by);
        }
        if ($this->isColumnModified(ChatsTableMap::COL_UPDATED_BY)) {
            $criteria->add(ChatsTableMap::COL_UPDATED_BY, $this->updated_by);
        }
        if ($this->isColumnModified(ChatsTableMap::COL_DELETED_BY)) {
            $criteria->add(ChatsTableMap::COL_DELETED_BY, $this->deleted_by);
        }
    ...
    {
        $criteria = ChildChatsQuery::create();
        $criteria->add(ChatsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \code\models\Chats (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \code\models\Chats Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ChatsTableMap::DEFAULT_STRING_FORMAT);
    }
